...
[`E_loo()`](https://mc-stan.org/loo/dev/reference/E_loo.md) function, so
...
- ...:
  ...
  [`E_loo()`](https://mc-stan.org/loo/dev/reference/E_loo.md)
...
- r_eff:
  ...
  [`psis()`](https://mc-stan.org/loo/dev/reference/psis.md) for more
  details.
