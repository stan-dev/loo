...
- x:
  ...
  [`psis()`](https://mc-stan.org/loo/dev/reference/psis.md), or
...
- plot_k:
  ...
  [`waic()`](https://mc-stan.org/loo/dev/reference/waic.md). To just
  plot \\k\\ without printing use the
  [plot()](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
