...
[`loo_i()`](https://mc-stan.org/loo/dev/reference/loo.md) function is a
...
[`loo()`](https://mc-stan.org/loo/dev/reference/loo.md), when using
[`loo_subsample()`](https://mc-stan.org/loo/dev/reference/loo_subsample.md)
...
[`help('pareto-k-diagnostic')`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
...
[`loo()`](https://mc-stan.org/loo/dev/reference/loo.md) instead of
[`loo_subsample()`](https://mc-stan.org/loo/dev/reference/loo_subsample.md)
or
[`loo_approximate_posterior()`](https://mc-stan.org/loo/dev/reference/loo_approximate_posterior.md).
...
[`obs_idx()`](https://mc-stan.org/loo/dev/reference/obs_idx.md) helper
function:
