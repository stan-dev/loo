...
#' deprecated but will be given precedence  over \code{mc.cores} until it is removed.
#' \strong{As of version 2.0.0 the default is now 1 core, but we recommend using
#' as many (or close to as many) cores as possible.}
