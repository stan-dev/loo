...
#' @param ... Ignored for \code{print}. For \code{plot}, \code{...} can contain
#'   arguments to pass to \code{\link[graphics]{text}} if \code{label_points =
#'   TRUE}.
...
#'   problematic. See section PSIS-LOO in \code{\link{loo-package}} for details
#'   on the interpretation of \eqn{k}. Ignored if \code{x} was generated by
#'   \code{\link{waic}}.
