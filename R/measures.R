...
#'
#' A convenience wrapper around [rps()] with `scaled = TRUE`. Computes the
...
#'
#' See [rps()] for full details on arguments, estimation, and references.
#'
#' @inheritParams rps
#'
#' @examples
