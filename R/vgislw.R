...
#'   of data points (see \code{\link{extract_log_lik}}).
#' @param wcp percentage of samples used for the generalized Pareto fit
#'   estimate.
...
#' @seealso \code{\link{vgisloo}}, which calls \code{vgislw}
#'
