...
#'
#' Small datasets for use in \pkg{loo} examples and vignettes. The \code{Kline}
#' and \code{milk} datasets are also included in the \pkg{rethinking} package
#' (McElreath, 2016a), but we include them here as \pkg{rethinking} is not yet
#' on CRAN.
#'
#' @name loo-datasets
#' @aliases Kline milk
...
#'   McElreath (2016a,2016b).
#'   (\href{https://www.rdocumentation.org/packages/rethinking/versions/1.59/topics/Kline}{Link to variable descriptions})
#' }
#' \item{\code{milk}}{
