...
- x:
  ...
  [`loo()`](https://mc-stan.org/loo/reference/loo.md)) or pointwise
  ...
  matrices then [`loo()`](https://mc-stan.org/loo/reference/loo.md) is
  called internally on each matrix. Currently the `loo_model_weights()`
...
- r_eff_list:
  ...
  [`psis()`](https://mc-stan.org/loo/reference/psis.md) and
...
- lpd_point:
  ...
  approximately using
  [`loo()`](https://mc-stan.org/loo/reference/loo.md) or by running
...
- [`loo()`](https://mc-stan.org/loo/reference/loo.md) for details on
