...
- observations:
  ...
  - `NULL` to use all observations. The algorithm then just uses
    standard [`loo()`](https://mc-stan.org/loo/reference/loo.md) or
...
- save_psis:
  ...
  [`loo()`](https://mc-stan.org/loo/reference/loo.md) for details.
...
objects returned by [`loo()`](https://mc-stan.org/loo/reference/loo.md)
