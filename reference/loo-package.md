...
[`loo()`](https://mc-stan.org/loo/reference/loo.md) function for
efficient approximate leave-one-out cross-validation (LOO-CV), the
[`psis()`](https://mc-stan.org/loo/reference/psis.md) function for the
Pareto smoothed importance sampling (PSIS) algorithm, or
