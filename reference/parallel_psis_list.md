...
- .llfun:
  ...
  See `llfun` in
  [`loo.function()`](https://mc-stan.org/loo/reference/loo.md).

- data, draws, ...:

  For the [`loo.function()`](https://mc-stan.org/loo/reference/loo.md)
  method and the [`loo_i()`](https://mc-stan.org/loo/reference/loo.md)
  function, these are the data, posterior draws, and other arguments to
  pass to the log-likelihood function. See the **Methods (by class)**
  section below for details on how to specify these arguments.
