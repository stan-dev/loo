...
([PSIS](https://mc-stan.org/loo/reference/psis.md)). This is an
...
- `estimates`:
  ...
  ([`elpd_loo`](https://mc-stan.org/loo/reference/loo-glossary.md)), the
  effective number of parameters
  ([`p_loo`](https://mc-stan.org/loo/reference/loo-glossary.md)) and the
  LOO information criterion `looic` (which is just `-2 * elpd_loo`,
...
- `pointwise`:
  ...
  [`elpd_loo`](https://mc-stan.org/loo/reference/loo-glossary.md)
  ([`mcse_elpd_loo`](https://mc-stan.org/loo/reference/loo-glossary.md)),
...
- `psis_object`:
  ...
  calls [`psis()`](https://mc-stan.org/loo/reference/psis.md) internally
  to do the PSIS procedure.
...
- [`psis()`](https://mc-stan.org/loo/reference/psis.md) for the
