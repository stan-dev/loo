...
When one wants to compare different models, the function `model_compare()` can be used to assess the difference in performance.
...
If one wants to compare several models (with `model_compare`), one should use the same folds for all the different models. 
