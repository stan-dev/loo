...
*The following is excerpted (with minor edits) from the appendix of the 
...
generated quantities {
  vector[N] log_lik;
  for (n in 1:N) {
    // new Stan syntax supported as of 2.10.0
    log_lik[n] = bernoulli_logit_lpmf(y[n] | beta0 + x[n] * beta);
  }
}
```
